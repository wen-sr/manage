...
public class DeviceStatus {
    ...
    public DeviceStatus(String deviceId, Integer deviceTypeId, String deviceTypeName, Integer deviceUserId, String deviceUserName, Integer status, Date adddate, Date editdate) {
