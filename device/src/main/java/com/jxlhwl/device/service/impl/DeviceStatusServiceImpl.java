...
import com.jxlhwl.common.Constant;
import com.jxlhwl.common.ServerResponse;
import com.jxlhwl.device.dao.*;
import com.jxlhwl.device.pojo.*;
import com.jxlhwl.device.service.DeviceStatusService;
import com.jxlhwl.device.vo.DeviceVo;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import com.jxlhwl.util.DateTimeUtil;
import com.jxlhwl.device.vo.RepairVo;
...
public class DeviceStatusServiceImpl implements DeviceStatusService {
    ...
    public ServerResponse takeReturn(String deviceId, Integer deviceTypeId, Integer status, Integer userId) {
        ...
        if(deviceStatus == null ){
            ...
            deviceStatus.setDeviceUserId(userId);
            ...
            deviceStatus.setStatus(status);
            deviceStatus.setDeviceUserId(-1);
    ...
    public ServerResponse<PageInfo> findRepair(DeviceRepair deviceRepair, int pageSize, int pageNum) {
        ...
        List<DeviceRepair> deviceRepairList = deviceRepairMapper.findAll(deviceRepair);
